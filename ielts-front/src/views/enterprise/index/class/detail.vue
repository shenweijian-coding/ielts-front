...
import { Plus } from '@idux/components';
...
<template>
  <div>
          ...
          <el-table-column prop="remark" label="备注" width="" align="center">
            <template #default="scope">
              <div class="flex items-center justify-center">
                ...
                <el-input v-else size="small" v-model="scope.row.remark" @enter="editRowFinish(scope.row)" style="width:100px" placeholder="请输入备注"></el-input>&nbsp;
    ...
    <booksDialog ref="booksDialogRef"></booksDialog>
  </div>
</template>
<script setup>
