  ...
  <div class="relative flex align-center pt-5 flex-col lg:flex-row">
    <div
      ...
      <div
        ...
        <h1 class="mb-1.5 text-xl font-normal text-gray-800 group-hover:color-theme dark:text-gray-200">班级名称</h1>
        <p class="mb-2 font-bold text-gray-600 dark:text-gray-200">成员数量：</p>
        <div class="w-full items-center hidden lg:flex"><img src="@/assets/images/book.png"
...
const handleToClassDetail = () => {
  router.push('/company/index/classDetail?id=')
}
</script>
